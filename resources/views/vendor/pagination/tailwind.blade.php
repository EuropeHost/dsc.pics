                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-sky-700 bg-sky-50 border border-sky-300 cursor-default leading-5 dark:bg-sky-900 dark:border-sky-700 dark:text-sky-300"
                                        >
                                            {{ $page }}
                                        </span>
                                    </span>

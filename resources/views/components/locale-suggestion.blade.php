@if(session()->has('suggested_locale') && session('suggested_locale') !== config('app.locale') && array_key_exists(session('suggested_locale'), config('app.locales', [])))
    ...
    >
        <div class="flex items-start">
            ...
            <button type="button" @click="show = false" class="-mx-1.5 -my-1.5 ms-auto inline-flex h-8 w-12 items-center justify-center rounded-lg bg-white p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-gray-300 dark:bg-gray-800 dark:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-white" aria-label="Close">

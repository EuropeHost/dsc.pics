    ...
    <div class="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div class="stat-card flex transform flex-col justify-between rounded-xl
            ...
            <div class="text-center">
                ...
                <p class="text-lg text-gray-700">
                    <i class="bi bi-eye-fill mr-2 text-sky-600"></i>
                    <strong>{{ __('content.link_views') }}:</strong>
                    <span class="animated-count" data-start="0"
                        data-end="{{ number_format($linkViewsLast30Days, 0, '.', '') }}"
                        data-decimals="0"></span>
                </p>
            </div>
            <div class="mt-6 border-t border-gray-200 pt-4 text-center">
                <p class="text-sm italic text-gray-500">
                    {{ __('content.data_for_period') }}
                </p>
            </div>
        </div>
        ...
        <div class="stat-card flex transform flex-col justify-between rounded-xl
            ...
            <div class="text-center">
                <h2 class="mb-4 text-2xl font-bold text-gray-800">
                    {{ __('content.stats_last_24_hours') }}
                </h2>
                <p class="mb-2 text-lg text-gray-700">
                    <i class="bi bi-image-fill mr-2 text-sky-600"></i>
                    <strong>{{ __('content.media') }}:</strong>
                ...
                <p class="text-lg text-gray-700">
                    ...
                    <strong>{{ __('content.link_views') }}:</strong>
                    <span class="animated-count" data-start="0"
                        data-end="{{ number_format($linkViewsLast24Hours, 0, '.', '') }}"
                        data-decimals="0"></span>
                </p>
            </div>
            <div class="mt-6 border-t border-gray-200 pt-4 text-center">

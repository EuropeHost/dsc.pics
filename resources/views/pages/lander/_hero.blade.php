<section
    ...
    "
    class="relative flex flex-col items-center justify-center overflow-hidden min-h-screen-minus-navbar bg-gray-50 dark:bg-gray-950"
>
    <svg class="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle
            ...
            cy="20%"
            r="120"
            class="fill-dscpics-500/10 dark:fill-dscpics-400/5"
        >
        ...
        <rect
            ...
            height="200"
            rx="20"
            class="fill-purple-500/10 dark:fill-purple-400/5"
        >
            <animateTransform
        ...
        <polygon
            points="45,80 50,70 55,80"
            class="fill-dscpics-400/10 dark:fill-dscpics-300/5"
            transform="translate(1200, 600) scale(30)"
        >
            <animateTransform
                attributeName="transform"
                type="translate"
                values="1200,600; 1250,650; 1200,600"
                dur="12s"
                repeatCount="indefinite"
            />
        </polygon>
    ...
    >
        <a
            href="#stats"
            class="flex flex-col items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-dscpics-600 dark:hover:text-dscpics-400 transition-colors duration-300 animate-bounce"
        >
            <svg
                class="w-8 h-8"
                viewBox="0 0 24 24"

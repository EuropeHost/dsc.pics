<section id="features" class="py-20 bg-gray-50 dark:bg-gray-950">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="p-8 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
            ...
            <div class="p-8 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 flex-shrink-0">
                        <svg class="w-8 h-8 text-yellow-600 dark:text-yellow-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-8 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex-shrink-0">
                        <svg class="w-8 h-8 text-purple-600 dark:text-purple-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
